...
namespace Lapins.Data.Music
{
    //[SongContent(AssetName = "Empire of madness", AssetPath = "musics/Empire of madness", Artist = "Spintronic", Name = "Empire of madness")]
    public class MusicPlayer
    {
        ...
        public MusicPlayer()
        {
           ...
           // _titleSong = Application.MagicContentManager.GetMusic("Epic-apocalyptic");
            //_winSong = Application.MagicContentManager.GetMusic("Cookie");
            //_loseSong = Application.MagicContentManager.GetMusic("Not cookie");
            _gameSong = new List<SongContentItem>();

            //_gameSong.Add(Application.MagicContentManager.GetMusic("Empire of madness"));
            //_gameSong.Add(Application.MagicContentManager.GetMusic("Epileptic"));
            //_gameSong.Add(Application.MagicContentManager.GetMusic("Supernova"));
            //_gameSong.Add(Application.MagicContentManager.GetMusic("Toothpaste"));
           // _gameSong.Add(Application.MagicContentManager.GetMusic("In Gameboy we trust"));
